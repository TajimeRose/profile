...
## Current public owner and allowlist — 23 July 2026

- Public name: Wongsathon Witthayakhom.
- Brand: TajimeRose.
- Public role: Frontend Developer.
- Public location: Samut Songkhram, Thailand.
...
- Current public projects:
  ...
  - DEV-LIFE, identified as a Bangkok University project and described as an
    active build without a verified public deployment.
- Owner-supplied profile, hero, NongPlatoo.Ai, and DEV-LIFE screenshots are
  approved for this portfolio.

This allowlist supersedes the Wildan-specific allowlist and project guardrails
later in this historical document.
...
- Identify DEV-LIFE as a Bangkok University project.
- The public repository supports claims about the Next.js workspace, Supabase
  data/authentication, project tools, XYFlow diagrams, and GitHub integration.
- Describe it as an active build with no verified continuously available public
  deployment.
- Do not claim production readiness, independent security review, or external
  adoption.
