...
// Validate ../../../src/app/instagram-qr/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/instagram-qr">> = Specific
  const handler = {} as typeof import("../../../src/app/instagram-qr/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
